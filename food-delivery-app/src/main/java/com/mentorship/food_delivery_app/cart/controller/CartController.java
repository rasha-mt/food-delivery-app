...
import com.mentorship.food_delivery_app.cart.service.implementation.CartServiceImpl;
...
public class CartController {
    ...
    public ResponseEntity<CartResponse> createCart() {
        ...
        CartResponse response = cartServiceImpl.createCart(customerId);
    ...
    public ResponseEntity<CartResponse> viewCart(){
        ...
        CartResponse response = cartServiceImpl.viewCart(customerId);
   ...
   public ResponseEntity<AddCartResponse> addItem(@RequestBody @Valid CartItemRequest item){
        // Adding Customer manually for testing
        UUID customerId = UUID.fromString("11111111-1111-1111-1111-111111111111");;//getCustomerIdFromToken(); // extracted from JWT
        AddCartResponse response = cartServiceImpl.addItem(item.getMenuItemId(),item.getQuantity(),customerId);
    ...
    public ResponseEntity<ClearCartResponse> clearCart(){
        // Adding Customer manually for testing
        UUID customerId = UUID.fromString("11111111-1111-1111-1111-111111111111");;//getCustomerIdFromToken(); // extracted from JWT
        ClearCartResponse response = cartServiceImpl.clearCart(customerId);
        return ResponseEntity.ok(response);
    }
